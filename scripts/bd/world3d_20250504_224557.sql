...
--
-- Name: cart_items_carts_lnk; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.cart_items_carts_lnk (
    id integer NOT NULL,
    cart_item_id integer,
    cart_id integer,
    cart_ord double precision,
    cart_item_ord double precision
);


ALTER TABLE public.cart_items_carts_lnk OWNER TO admin;

--
-- Name: cart_items_carts_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.cart_items_carts_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.cart_items_carts_lnk_id_seq OWNER TO admin;

--
-- Name: cart_items_carts_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.cart_items_carts_lnk_id_seq OWNED BY public.cart_items_carts_lnk.id;
...
--
-- Name: cart_items_products_lnk; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.cart_items_products_lnk (
    id integer NOT NULL,
    cart_item_id integer,
    product_id integer,
    product_ord double precision,
...
ALTER TABLE public.cart_items_products_lnk OWNER TO admin;

--
-- Name: cart_items_products_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.cart_items_products_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.cart_items_products_lnk_id_seq OWNER TO admin;

--
-- Name: cart_items_products_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.cart_items_products_lnk_id_seq OWNED BY public.cart_items_products_lnk.id;
...
CREATE TABLE public.carts (
    ...
    create_at character varying(255),
...
--
-- Name: carts_brand_lnk; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.carts_brand_lnk (
    id integer NOT NULL,
    cart_id integer,
    brand_id integer
);
...
ALTER TABLE public.carts_brand_lnk OWNER TO admin;

--
-- Name: carts_brand_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.carts_brand_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.carts_brand_lnk_id_seq OWNER TO admin;

--
-- Name: carts_brand_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.carts_brand_lnk_id_seq OWNED BY public.carts_brand_lnk.id;
...
--
-- Name: carts_product_lnk; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.carts_product_lnk (
    id integer NOT NULL,
    cart_id integer,
    product_id integer,
    cart_ord double precision
...
ALTER TABLE public.carts_product_lnk OWNER TO admin;

--
-- Name: carts_product_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.carts_product_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.carts_product_lnk_id_seq OWNER TO admin;

--
-- Name: carts_product_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.carts_product_lnk_id_seq OWNED BY public.carts_product_lnk.id;


--
-- Name: carts_users_permissions_user_lnk; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.carts_users_permissions_user_lnk (
    id integer NOT NULL,
    cart_id integer,
    user_id integer
);
...
ALTER TABLE public.carts_users_permissions_user_lnk OWNER TO admin;

--
-- Name: carts_users_permissions_user_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--

CREATE SEQUENCE public.carts_users_permissions_user_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.carts_users_permissions_user_lnk_id_seq OWNER TO admin;

--
-- Name: carts_users_permissions_user_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--

ALTER SEQUENCE public.carts_users_permissions_user_lnk_id_seq OWNED BY public.carts_users_permissions_user_lnk.id;
...
--
-- Name: cart_items_carts_lnk id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_carts_lnk ALTER COLUMN id SET DEFAULT nextval('public.cart_items_carts_lnk_id_seq'::regclass);


--
-- Name: cart_items_products_lnk id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_products_lnk ALTER COLUMN id SET DEFAULT nextval('public.cart_items_products_lnk_id_seq'::regclass);
...
--
-- Name: carts_brand_lnk id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_brand_lnk ALTER COLUMN id SET DEFAULT nextval('public.carts_brand_lnk_id_seq'::regclass);


--
-- Name: carts_product_lnk id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_product_lnk ALTER COLUMN id SET DEFAULT nextval('public.carts_product_lnk_id_seq'::regclass);


--
-- Name: carts_users_permissions_user_lnk id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_users_permissions_user_lnk ALTER COLUMN id SET DEFAULT nextval('public.carts_users_permissions_user_lnk_id_seq'::regclass);
...
352	wtbkxzw0hlny8xcvkidyc813	plugin::content-manager.explorer.create	{}	plugin::users-permissions.user	{"fields": ["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role", "product_ratings", "avatar", "products", "userId", "reactions", "cart"]}	[]	2025-05-03 21:54:32.531	2025-05-03 21:54:32.531	2025-05-03 21:54:32.531	\N	\N	\N
374	v7fq0kqtmhgqvneqa1wkuir8	plugin::content-manager.explorer.create	{}	api::cart.cart	{"fields": ["cartId", "createAt", "createBy", "users_permissions_user", "product", "quantity", "time", "price", "brand", "cart_items"]}	[]	2025-05-03 22:00:23.208	2025-05-03 22:00:23.208	2025-05-03 22:00:23.208	\N	\N	\N
...
375	puwbmnnrzdk2cksnt1yrcdaq	plugin::content-manager.explorer.read	{}	api::cart.cart	{"fields": ["cartId", "createAt", "createBy", "users_permissions_user", "product", "quantity", "time", "price", "brand", "cart_items"]}	[]	2025-05-03 22:00:23.213	2025-05-03 22:00:23.213	2025-05-03 22:00:23.213	\N	\N	\N
...
355	f5xyx0u5m12u1iu5vjy5xgl4	plugin::content-manager.explorer.read	{}	plugin::users-permissions.user	{"fields": ["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role", "product_ratings", "avatar", "products", "userId", "reactions", "cart"]}	[]	2025-05-03 21:54:32.538	2025-05-03 21:54:32.538	2025-05-03 21:54:32.539	\N	\N	\N
...
358	ufkwb3r1mbrecyj2utwrlaxy	plugin::content-manager.explorer.update	{}	plugin::users-permissions.user	{"fields": ["username", "email", "provider", "password", "resetPasswordToken", "confirmationToken", "confirmed", "blocked", "role", "product_ratings", "avatar", "products", "userId", "reactions", "cart"]}	[]	2025-05-03 21:54:32.544	2025-05-03 21:54:32.544	2025-05-03 21:54:32.544	\N	\N	\N
361	fxwghpazliaszo8xo0453ypq	plugin::content-manager.explorer.delete	{}	api::cart.cart	{}	[]	2025-05-03 21:54:32.55	2025-05-03 21:54:32.55	2025-05-03 21:54:32.55	\N	\N	\N
362	ohvyfn35oumao2zywpzkkueb	plugin::content-manager.explorer.publish	{}	api::cart.cart	{}	[]	2025-05-03 21:54:32.551	2025-05-03 21:54:32.551	2025-05-03 21:54:32.551	\N	\N	\N
376	mqie9qjcnt0952ndy82twrws	plugin::content-manager.explorer.update	{}	api::cart.cart	{"fields": ["cartId", "createAt", "createBy", "users_permissions_user", "product", "quantity", "time", "price", "brand", "cart_items"]}	[]	2025-05-03 22:00:23.217	2025-05-03 22:00:23.217	2025-05-03 22:00:23.217	\N	\N	\N
377	nsv0eeqe48xcqgzhxau4hghz	plugin::content-manager.explorer.delete	{}	api::cart.cart	{}	[]	2025-05-03 22:00:23.22	2025-05-03 22:00:23.22	2025-05-03 22:00:23.22	\N	\N	\N
378	tiocm0zs1pjbsbvmc93jiv90	plugin::content-manager.explorer.publish	{}	api::cart.cart	{}	[]	2025-05-03 22:00:23.223	2025-05-03 22:00:23.223	2025-05-03 22:00:23.223	\N	\N	\N
379	kaka3o364wi1zsqlvfacn3fh	plugin::content-manager.explorer.create	{}	api::cart-item.cart-item	{"fields": ["carts", "products", "countProduct", "price", "addedAt"]}	[]	2025-05-03 22:00:23.225	2025-05-03 22:00:23.225	2025-05-03 22:00:23.225	\N	\N	\N
380	vay87k2ihy99ikllqnmnhchj	plugin::content-manager.explorer.read	{}	api::cart-item.cart-item	{"fields": ["carts", "products", "countProduct", "price", "addedAt"]}	[]	2025-05-03 22:00:23.227	2025-05-03 22:00:23.227	2025-05-03 22:00:23.227	\N	\N	\N
381	k98cz6owcy5x9tzjzvwm4trw	plugin::content-manager.explorer.update	{}	api::cart-item.cart-item	{"fields": ["carts", "products", "countProduct", "price", "addedAt"]}	[]	2025-05-03 22:00:23.229	2025-05-03 22:00:23.229	2025-05-03 22:00:23.23	\N	\N	\N
382	zguy38w9yls6mnpkha3ruevs	plugin::content-manager.explorer.delete	{}	api::cart-item.cart-item	{}	[]	2025-05-03 22:00:23.232	2025-05-03 22:00:23.232	2025-05-03 22:00:23.232	\N	\N	\N
383	c7chhercpgsmmxqx8s94agfc	plugin::content-manager.explorer.publish	{}	api::cart-item.cart-item	{}	[]	2025-05-03 22:00:23.234	2025-05-03 22:00:23.234	2025-05-03 22:00:23.234	\N	\N	\N
...
363	o6yl8lut7fxparsxasxuk3o0	plugin::content-manager.explorer.create	{}	api::cart.cart	{"fields": ["cartId", "createAt", "createBy", "users_permissions_user", "product", "quantity", "time", "price", "brand", "cart_items"]}	[]	2025-05-03 21:59:51.159	2025-05-03 21:59:51.159	2025-05-03 21:59:51.159	\N	\N	\N
364	vioj9p9cjocaedxc8acrnaqt	plugin::content-manager.explorer.create	{}	api::cart-item.cart-item	{"fields": ["carts", "products", "countProduct", "price", "addedAt"]}	[]	2025-05-03 21:59:51.171	2025-05-03 21:59:51.171	2025-05-03 21:59:51.171	\N	\N	\N
365	amn9q168684g3tltn0y3kyd8	plugin::content-manager.explorer.create	{}	api::product.product	{"fields": ["productName", "slug", "description", "images", "active", "price", "isFeatured", "categories", "weight", "dimensions", "dateManufactured", "remaininWarranty", "State", "cityName", "provinceName", "countryName", "directionName", "latitud", "longitud", "shipping_types", "brands", "product_ratings", "averageRating", "totalRatings", "views", "favorites", "createBy", "users_permissions_users", "owner_id", "reactions", "carts", "cart_items"]}	[]	2025-05-03 21:59:51.177	2025-05-03 21:59:51.177	2025-05-03 21:59:51.177	\N	\N	\N
366	ihv708260b2585u5benpqm7m	plugin::content-manager.explorer.read	{}	api::cart.cart	{"fields": ["cartId", "createAt", "createBy", "users_permissions_user", "product", "quantity", "time", "price", "brand", "cart_items"]}	[]	2025-05-03 21:59:51.181	2025-05-03 21:59:51.181	2025-05-03 21:59:51.181	\N	\N	\N
367	k8rh6zlaebyt302gbht2twa2	plugin::content-manager.explorer.read	{}	api::cart-item.cart-item	{"fields": ["carts", "products", "countProduct", "price", "addedAt"]}	[]	2025-05-03 21:59:51.184	2025-05-03 21:59:51.184	2025-05-03 21:59:51.184	\N	\N	\N
368	qlnfxbj943pjitz4pww51jbi	plugin::content-manager.explorer.read	{}	api::product.product	{"fields": ["productName", "slug", "description", "images", "active", "price", "isFeatured", "categories", "weight", "dimensions", "dateManufactured", "remaininWarranty", "State", "cityName", "provinceName", "countryName", "directionName", "latitud", "longitud", "shipping_types", "brands", "product_ratings", "averageRating", "totalRatings", "views", "favorites", "createBy", "users_permissions_users", "owner_id", "reactions", "carts", "cart_items"]}	[]	2025-05-03 21:59:51.186	2025-05-03 21:59:51.186	2025-05-03 21:59:51.186	\N	\N	\N
369	h781v3uhjpds1xbwpompy3rs	plugin::content-manager.explorer.update	{}	api::cart.cart	{"fields": ["cartId", "createAt", "createBy", "users_permissions_user", "product", "quantity", "time", "price", "brand", "cart_items"]}	[]	2025-05-03 21:59:51.189	2025-05-03 21:59:51.189	2025-05-03 21:59:51.189	\N	\N	\N
370	cvh40fipyuwwglfahx5643qh	plugin::content-manager.explorer.update	{}	api::cart-item.cart-item	{"fields": ["carts", "products", "countProduct", "price", "addedAt"]}	[]	2025-05-03 21:59:51.191	2025-05-03 21:59:51.191	2025-05-03 21:59:51.191	\N	\N	\N
371	sd5q5uaec6h4qg7dzw8a66px	plugin::content-manager.explorer.update	{}	api::product.product	{"fields": ["productName", "slug", "description", "images", "active", "price", "isFeatured", "categories", "weight", "dimensions", "dateManufactured", "remaininWarranty", "State", "cityName", "provinceName", "countryName", "directionName", "latitud", "longitud", "shipping_types", "brands", "product_ratings", "averageRating", "totalRatings", "views", "favorites", "createBy", "users_permissions_users", "owner_id", "reactions", "carts", "cart_items"]}	[]	2025-05-03 21:59:51.194	2025-05-03 21:59:51.194	2025-05-03 21:59:51.194	\N	\N	\N
372	deu8kaa6xdnzazp8aj38l9fp	plugin::content-manager.explorer.delete	{}	api::cart-item.cart-item	{}	[]	2025-05-03 21:59:51.196	2025-05-03 21:59:51.196	2025-05-03 21:59:51.196	\N	\N	\N
373	pg1ep8q7xd9upx5d2nlftvr3	plugin::content-manager.explorer.publish	{}	api::cart-item.cart-item	{}	[]	2025-05-03 21:59:51.198	2025-05-03 21:59:51.198	2025-05-03 21:59:51.198	\N	\N	\N
\.
...
3	tumm3tffzf5i3lrpmhk8e0yh	User	strapi-author	Authors can manage the content they have created.	2025-04-14 19:18:04.347	2025-05-03 22:00:23.124	2025-04-14 19:18:04.347	\N	\N	\N
\.
...
COPY public.cart_items (id, document_id, count_product, price, added_at, created_at, updated_at, published_at, created_by_id, updated_by_id, locale) FROM stdin;
\.


--
-- Data for Name: cart_items_carts_lnk; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.cart_items_carts_lnk (id, cart_item_id, cart_id, cart_ord, cart_item_ord) FROM stdin;
\.


--
-- Data for Name: cart_items_products_lnk; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.cart_items_products_lnk (id, cart_item_id, product_id, product_ord, cart_item_ord) FROM stdin;
\.
...
COPY public.carts (id, document_id, cart_id, create_at, create_by, quantity, "time", price, created_at, updated_at, published_at, created_by_id, updated_by_id, locale) FROM stdin;
1	siv7jjhhppczhrkfi52e3z9z	ORD-5570	Pedido completado	\N	1	2025-05-04 21:45:08.396	399.99	2025-05-04 21:45:08.4	2025-05-04 21:45:08.4	\N	\N	\N	\N
2	siv7jjhhppczhrkfi52e3z9z	ORD-5570	Pedido completado	\N	1	2025-05-04 21:45:08.396	399.99	2025-05-04 21:45:08.4	2025-05-04 21:45:08.4	2025-05-04 21:45:08.409	\N	\N	\N
3	o0dhdtcen2hdzsuv2m8c7h3t	TEST-123	Pedido completado	\N	1	2025-05-04 23:30:00	99.99	2025-05-04 21:45:20.657	2025-05-04 21:45:20.657	\N	\N	\N	\N
4	o0dhdtcen2hdzsuv2m8c7h3t	TEST-123	Pedido completado	\N	1	2025-05-04 23:30:00	99.99	2025-05-04 21:45:20.657	2025-05-04 21:45:20.657	2025-05-04 21:45:20.666	\N	\N	\N
5	gd4atswwsfdtgx1wk2dpxb4s	ORD-3452	Pedido completado	\N	1	2025-05-04 21:47:04.414	499.99	2025-05-04 21:47:04.419	2025-05-04 21:47:04.419	\N	\N	\N	\N
6	gd4atswwsfdtgx1wk2dpxb4s	ORD-3452	Pedido completado	\N	1	2025-05-04 21:47:04.414	499.99	2025-05-04 21:47:04.419	2025-05-04 21:47:04.419	2025-05-04 21:47:04.427	\N	\N	\N
7	toblt59u9rh2b3xd65qy55lo	ORD-6215	Pedido completado	Usuario 3	1	2025-05-04 21:51:38.335	349.99	2025-05-04 21:51:38.341	2025-05-04 21:51:38.341	\N	\N	\N	\N
8	toblt59u9rh2b3xd65qy55lo	ORD-6215	Pedido completado	Usuario 3	1	2025-05-04 21:51:38.335	349.99	2025-05-04 21:51:38.341	2025-05-04 21:51:38.341	2025-05-04 21:51:38.353	\N	\N	\N
9	pl01pexvvbeg1kzfpkeuu7nc	ORD-9665	Pedido completado	Usuario 3	1	2025-05-04 21:57:16.968	29.99	2025-05-04 21:57:16.974	2025-05-04 21:57:16.974	\N	\N	\N	\N
10	pl01pexvvbeg1kzfpkeuu7nc	ORD-9665	Pedido completado	Usuario 3	1	2025-05-04 21:57:16.968	29.99	2025-05-04 21:57:16.974	2025-05-04 21:57:16.974	2025-05-04 21:57:16.985	\N	\N	\N
11	q8kn4blv5861q36qzmux7m8d	ORD-5215	Pedido completado	Usuario 3	1	2025-05-04 22:04:02.329	29.99	2025-05-04 22:04:02.335	2025-05-04 22:04:02.335	\N	\N	\N	\N
12	q8kn4blv5861q36qzmux7m8d	ORD-5215	Pedido completado	Usuario 3	1	2025-05-04 22:04:02.329	29.99	2025-05-04 22:04:02.335	2025-05-04 22:04:02.335	2025-05-04 22:04:02.345	\N	\N	\N
13	stv44t8e3yshi8w0nlt94bxc	ORD-5315	Pedido completado	Usuario 3	1	2025-05-04 22:10:44.072	29.99	2025-05-04 22:10:44.077	2025-05-04 22:10:44.077	\N	\N	\N	\N
14	stv44t8e3yshi8w0nlt94bxc	ORD-5315	Pedido completado	Usuario 3	1	2025-05-04 22:10:44.072	29.99	2025-05-04 22:10:44.077	2025-05-04 22:10:44.077	2025-05-04 22:10:44.096	\N	\N	\N
15	igua0k6jn55xav25m3genbf8	ORD-8233	Pedido completado	Usuario 3	1	2025-05-04 22:13:21.984	29.99	2025-05-04 22:13:21.989	2025-05-04 22:13:21.989	\N	\N	\N	\N
16	igua0k6jn55xav25m3genbf8	ORD-8233	Pedido completado	Usuario 3	1	2025-05-04 22:13:21.984	29.99	2025-05-04 22:13:21.989	2025-05-04 22:13:21.989	2025-05-04 22:13:21.997	\N	\N	\N
17	ih7g9qlc8whd9idhdf2lv567	ORD-5464	Pedido completado	Usuario 3	1	2025-05-04 22:15:12.208	599.99	2025-05-04 22:15:12.214	2025-05-04 22:15:12.214	\N	\N	\N	\N
18	ih7g9qlc8whd9idhdf2lv567	ORD-5464	Pedido completado	Usuario 3	1	2025-05-04 22:15:12.208	599.99	2025-05-04 22:15:12.214	2025-05-04 22:15:12.214	2025-05-04 22:15:12.222	\N	\N	\N
19	flf9a7i8iq8fu3zug2cs7r4o	ORD-4431	Pedido completado	Usuario 3	1	2025-05-04 22:15:14.395	0.00	2025-05-04 22:15:14.401	2025-05-04 22:15:14.401	\N	\N	\N	\N
20	flf9a7i8iq8fu3zug2cs7r4o	ORD-4431	Pedido completado	Usuario 3	1	2025-05-04 22:15:14.395	0.00	2025-05-04 22:15:14.401	2025-05-04 22:15:14.401	2025-05-04 22:15:14.41	\N	\N	\N
21	via2l6knwbs8o98hrqs3sy3l	ORD-2305	Pedido completado	Usuario 3	1	2025-05-04 22:23:45.571	599.99	2025-05-04 22:23:45.576	2025-05-04 22:23:45.576	\N	\N	\N	\N
22	via2l6knwbs8o98hrqs3sy3l	ORD-2305	Pedido completado	Usuario 3	1	2025-05-04 22:23:45.571	599.99	2025-05-04 22:23:45.576	2025-05-04 22:23:45.576	2025-05-04 22:23:45.584	\N	\N	\N
23	e9n4x2i0bsdigp1idth8kjq2	ORD-6891	Pedido completado	Usuario 3	1	2025-05-04 22:23:47.781	0.00	2025-05-04 22:23:47.785	2025-05-04 22:23:47.785	\N	\N	\N	\N
24	e9n4x2i0bsdigp1idth8kjq2	ORD-6891	Pedido completado	Usuario 3	1	2025-05-04 22:23:47.781	0.00	2025-05-04 22:23:47.785	2025-05-04 22:23:47.785	2025-05-04 22:23:47.796	\N	\N	\N
25	ilw5nq1r7xedhhex8iqj402v	ORD-6263	Pedido completado	Usuario 3	1	2025-05-04 22:42:59.381	599.99	2025-05-04 22:42:59.387	2025-05-04 22:42:59.387	\N	\N	\N	\N
26	ilw5nq1r7xedhhex8iqj402v	ORD-6263	Pedido completado	Usuario 3	1	2025-05-04 22:42:59.381	599.99	2025-05-04 22:42:59.387	2025-05-04 22:42:59.387	2025-05-04 22:42:59.397	\N	\N	\N
27	qkqw5kuqeeimxmqmygnhgwk7	ORD-5213	Pedido completado	Usuario 3	1	2025-05-04 22:43:01.137	0.00	2025-05-04 22:43:01.141	2025-05-04 22:43:01.141	\N	\N	\N	\N
28	qkqw5kuqeeimxmqmygnhgwk7	ORD-5213	Pedido completado	Usuario 3	1	2025-05-04 22:43:01.137	0.00	2025-05-04 22:43:01.141	2025-05-04 22:43:01.141	2025-05-04 22:43:01.152	\N	\N	\N
\.


--
-- Data for Name: carts_brand_lnk; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.carts_brand_lnk (id, cart_id, brand_id) FROM stdin;
\.


--
-- Data for Name: carts_product_lnk; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.carts_product_lnk (id, cart_id, product_id, cart_ord) FROM stdin;
\.


--
-- Data for Name: carts_users_permissions_user_lnk; Type: TABLE DATA; Schema: public; Owner: admin
--

COPY public.carts_users_permissions_user_lnk (id, cart_id, user_id) FROM stdin;
21	27	3
22	28	3
\.
...
25	vsgigyiwn4cl91zpnj1a57bx	2025-05-04 19:51:57.83	2025-05-04 19:51:57.83	\N	\N	\N	\N
26	vsgigyiwn4cl91zpnj1a57bx	2025-05-04 19:51:57.83	2025-05-04 19:51:57.83	2025-05-04 19:51:57.841	\N	\N	\N
\.
...
2731	50	588	api::product.product	images	1
2732	51	588	api::product.product	images	2
2733	52	588	api::product.product	images	3
2734	53	588	api::product.product	images	4
2735	54	588	api::product.product	images	5
2736	55	588	api::product.product	images	6
...
2737	56	588	api::product.product	images	7
...
2805	159	603	api::product.product	images	1
2806	160	603	api::product.product	images	2
2807	161	603	api::product.product	images	3
2808	162	603	api::product.product	images	4
2809	163	603	api::product.product	images	5
...
2773	214	596	api::product.product	images	1
...
2774	215	596	api::product.product	images	2
2775	216	596	api::product.product	images	3
2776	217	596	api::product.product	images	4
2777	218	596	api::product.product	images	5
...
2778	276	597	api::product.product	images	1
2779	277	597	api::product.product	images	2
...
2743	67	590	api::product.product	images	1
2744	68	590	api::product.product	images	2
2745	69	590	api::product.product	images	3
2746	70	590	api::product.product	images	4
2747	71	590	api::product.product	images	5
...
2716	42	586	api::product.product	images	1
2717	43	586	api::product.product	images	2
2718	44	586	api::product.product	images	3
2719	45	586	api::product.product	images	4
2720	46	586	api::product.product	images	5
2721	47	586	api::product.product	images	6
2722	48	586	api::product.product	images	7
2723	49	586	api::product.product	images	8
...
2464	235	526	api::product.product	images	1
2465	237	526	api::product.product	images	2
2466	236	526	api::product.product	images	3
2467	238	526	api::product.product	images	4
2468	239	526	api::product.product	images	5
...
17	sj59677asb34lqxb7dksoero	Elegoo Neptune 3 Pro	elegoo-neptune-3-pro	Impresora 3D Elegoo Neptune 3 Pro con pantalla táctil	t	349.99	t	2025-04-15 20:58:03.776	2025-05-04 21:51:34.022	\N	1	1	\N	8.50	35x35x30	2022-04-07	Sin Garantia	Seminuevo	Toledo	Toledo	España	Calle Real 606	39.862832	-4.027323	\N	\N	9	\N	\N
590	sj59677asb34lqxb7dksoero	Elegoo Neptune 3 Pro	elegoo-neptune-3-pro	Impresora 3D Elegoo Neptune 3 Pro con pantalla táctil	t	349.99	t	2025-04-15 20:58:03.776	2025-05-04 21:51:34.022	2025-05-04 21:51:34.039	1	1	\N	8.50	35x35x30	2022-04-07	Sin Garantia	Seminuevo	Toledo	Toledo	España	Calle Real 606	39.862832	-4.027323	\N	\N	9	\N	\N
...
596	x750yufmey1bekoymdo0dhyx	Kit de reparación para impresoras 3D	kit-de-reparacion-para-impresoras-3-d	Kit de reparación para impresoras 3D	t	29.99	t	2025-04-16 21:57:54.317	2025-05-04 22:10:36.676	2025-05-04 22:10:36.689	1	1	\N	5.50	20x20x5	2025-04-02	24 meses	Nuevo	Toledo	Toledo	España	Calle Real 606	39.862832	-4.027323	\N	\N	28	\N	\N
552	c522t3yqwwnxi0h6z4b8ivk4	prueba dd	prueba-dd	t23ty234t	t	2000.00	f	2025-05-03 20:22:13.392	2025-05-04 19:39:10.454	2025-05-04 19:39:10.592	\N	\N	\N	0.00		\N	\N	Nuevo			España		\N	\N	\N	\N	1	\N	3
...
597	w0j0zu7b86cis1ksonpkcmsx	Resina para impresoras 3D dental	resina-para-impresoras-3-d-dental	Resina para impresoras 3D para uso dental	t	29.99	\N	2025-04-17 11:51:40.285	2025-05-04 22:13:16.545	2025-05-04 22:13:16.626	1	1	\N	6.50	10x10x5	2025-04-02	24 meses	Nuevo	Sevilla	Sevilla	España	Calle Mateos Gago 8	37.389091	-5.984459	\N	\N	14	\N	\N
...
554	zxqt0brjz9wu085lzi23891m	Bambu Lab X1 Carbon prueba2	bambu-lab-x1-carbon-prueba2	joiuoiu	t	2000.00	f	2025-05-03 20:03:12.123	2025-05-04 19:39:28.345	2025-05-04 19:39:28.375	\N	\N	\N	5.50	20x20x20	\N	\N	Seminuevo	Ontinyent	Valencia	España	C/Purisima n11	\N	\N	\N	\N	1	\N	3
...
105	f5om3kms72w835mm6gk88you	Soporte angular para perfiles	soporte-angular-para-perfiles	Soporte angular para perfiles de aluminio	t	29.99	\N	2025-04-16 22:22:52.573	2025-05-03 21:08:34.488	\N	1	1	\N	5.50	5x5x5	2023-01-02	24 meses	Nuevo	Palma de Mallorca	Palma de Mallorca	España	Calle Jaime III 1313	39.5696	2.65016	\N	\N	1	\N	\N
526	f5om3kms72w835mm6gk88you	Soporte angular para perfiles	soporte-angular-para-perfiles	Soporte angular para perfiles de aluminio	t	29.99	\N	2025-04-16 22:22:52.573	2025-05-03 21:08:34.488	2025-05-03 21:08:34.512	1	1	\N	5.50	5x5x5	2023-01-02	24 meses	Nuevo	Palma de Mallorca	Palma de Mallorca	España	Calle Jaime III 1313	39.5696	2.65016	\N	\N	1	\N	\N
...
141	w0j0zu7b86cis1ksonpkcmsx	Resina para impresoras 3D dental	resina-para-impresoras-3-d-dental	Resina para impresoras 3D para uso dental	t	29.99	\N	2025-04-17 11:51:40.285	2025-05-04 22:13:16.545	\N	1	1	\N	6.50	10x10x5	2025-04-02	24 meses	Nuevo	Sevilla	Sevilla	España	Calle Mateos Gago 8	37.389091	-5.984459	\N	\N	14	\N	\N
...
58	wbbmy79cr4t6l6rtivaph4f0	Anycubic Photon Mono X 6K	anycubic-photon-mono-x-6-k	Impresora 3D de resina Anycubic Photon Mono X 6K	t	599.99	t	2025-04-16 19:37:09.791	2025-05-04 22:42:52.771	\N	1	1	\N	7.80	25x25x30	2023-01-02	6 meses	Seminuevo	Cádiz	Cádiz	España	Calle Ancha 1010	36.529781	-6.292657	\N	\N	25	\N	\N
...
9	q4h4qhlwkm5xo49gvnnef5ws	Anycubic Kobra 2 Max	anycubic-kobra-2-max	Impresora 3D Anycubic Kobra 2 Max en excelente estado	t	399.99	t	2025-04-15 20:39:05.367	2025-05-04 21:45:04.875	\N	1	1	\N	9.20	45x45x40	2025-04-03	24 meses	Nuevo	Bilbao	Bilbao	España	Calle Ledesma 202	43.263013	-2.934985	4.50	2	30	\N	\N
...
579	he791r9cz0446lz816e25k4h	Test Product	test-product	Test Description	t	100.00	\N	2025-05-03 19:03:48.033	2025-05-04 21:08:45.955	2025-05-04 21:08:46.042	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2	\N	\N
...
603	wbbmy79cr4t6l6rtivaph4f0	Anycubic Photon Mono X 6K	anycubic-photon-mono-x-6-k	Impresora 3D de resina Anycubic Photon Mono X 6K	t	599.99	t	2025-04-16 19:37:09.791	2025-05-04 22:42:52.771	2025-05-04 22:42:52.793	1	1	\N	7.80	25x25x30	2023-01-02	6 meses	Seminuevo	Cádiz	Cádiz	España	Calle Ancha 1010	36.529781	-6.292657	\N	\N	25	\N	\N
...
505	he791r9cz0446lz816e25k4h	Test Product	test-product	Test Description	t	100.00	\N	2025-05-03 19:03:48.033	2025-05-04 21:08:45.955	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2	\N	\N
...
90	x750yufmey1bekoymdo0dhyx	Kit de reparación para impresoras 3D	kit-de-reparacion-para-impresoras-3-d	Kit de reparación para impresoras 3D	t	29.99	t	2025-04-16 21:57:54.317	2025-05-04 22:10:36.676	\N	1	1	\N	5.50	20x20x5	2025-04-02	24 meses	Nuevo	Toledo	Toledo	España	Calle Real 606	39.862832	-4.027323	\N	\N	28	\N	\N
513	zxqt0brjz9wu085lzi23891m	Bambu Lab X1 Carbon prueba2	bambu-lab-x1-carbon-prueba2	joiuoiu	t	2000.00	f	2025-05-03 20:03:12.123	2025-05-04 19:39:28.345	\N	\N	\N	\N	5.50	20x20x20	\N	\N	Seminuevo	Ontinyent	Valencia	España	C/Purisima n11	\N	\N	\N	\N	1	\N	3
586	q4h4qhlwkm5xo49gvnnef5ws	Anycubic Kobra 2 Max	anycubic-kobra-2-max	Impresora 3D Anycubic Kobra 2 Max en excelente estado	t	399.99	t	2025-04-15 20:39:05.367	2025-05-04 21:45:04.875	2025-05-04 21:45:04.903	1	1	\N	9.20	45x45x40	2025-04-03	24 meses	Nuevo	Bilbao	Bilbao	España	Calle Ledesma 202	43.263013	-2.934985	4.50	2	30	\N	\N
...
588	oge9xhtfdtb0selfez1cpmkr	Anycubic Photon Mono X	anycubic-photon-mono-x	Impresora 3D de resina Anycubic Photon Mono X	t	499.99	t	2025-04-15 20:44:08.546	2025-05-04 21:46:59.729	2025-05-04 21:46:59.749	1	1	\N	7.80	25x25x30	2023-01-02	Sin Garantia	Seminuevo	Málaga	Málaga	España	Avenida Andalucía 303	36.721261	-4.421266	\N	\N	36	\N	\N
...
519	c522t3yqwwnxi0h6z4b8ivk4	prueba dd	prueba-dd	t23ty234t	t	2000.00	f	2025-05-03 20:22:13.392	2025-05-04 19:39:10.454	\N	\N	\N	\N	0.00		\N	\N	Nuevo			España		\N	\N	\N	\N	1	\N	3
\.
...
33	lcwmwwwnxcwcu14ug15lhaw4	\N	\N	\N	\N	like	t	2025-05-04 19:51:41.998	2025-05-04 19:51:41.998	\N	\N	\N	\N
34	lcwmwwwnxcwcu14ug15lhaw4	\N	\N	\N	\N	like	t	2025-05-04 19:51:41.998	2025-05-04 19:51:41.998	2025-05-04 19:51:42.009	\N	\N	\N
\.
...
4	rtjkd21zxk5qd00ymu965pkn	Authenticated		full-access	1ea0f374ec839870e20cc5a78bf714bf7ea00025621f733496a9e2c64a9aaead91545f765d0b20539c0a153641469e3a6b7bb3ca1d057ea23db54a87f5e5dc6d	\N	\N	\N	2025-05-04 21:41:48.517	2025-05-04 21:41:48.517	2025-05-04 21:41:48.517	\N	\N	\N
\.
...
42	plugin_content_manager_configuration_content_types::api::cart-item.cart-item	{"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"id","defaultSortBy":"id","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"carts":{"edit":{"label":"carts","description":"","placeholder":"","visible":true,"editable":true,"mainField":"createAt"},"list":{"label":"carts","searchable":false,"sortable":false}},"products":{"edit":{"label":"products","description":"","placeholder":"","visible":true,"editable":true,"mainField":"productName"},"list":{"label":"products","searchable":false,"sortable":false}},"countProduct":{"edit":{"label":"countProduct","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"countProduct","searchable":true,"sortable":true}},"price":{"edit":{"label":"price","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"price","searchable":true,"sortable":true}},"addedAt":{"edit":{"label":"addedAt","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"addedAt","searchable":true,"sortable":true}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}},"createdBy":{"edit":{"label":"createdBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"createdBy","searchable":true,"sortable":true}},"updatedBy":{"edit":{"label":"updatedBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"updatedBy","searchable":true,"sortable":true}}},"layouts":{"list":["id","carts","products","countProduct"],"edit":[[{"name":"carts","size":6},{"name":"products","size":6}],[{"name":"countProduct","size":4},{"name":"price","size":4}],[{"name":"addedAt","size":6}]]},"uid":"api::cart-item.cart-item"}	object	\N	\N
41	plugin_content_manager_configuration_content_types::api::cart.cart	{"settings":{"bulkable":true,"filterable":true,"searchable":true,"pageSize":10,"mainField":"createAt","defaultSortBy":"createAt","defaultSortOrder":"ASC"},"metadatas":{"id":{"edit":{},"list":{"label":"id","searchable":true,"sortable":true}},"cartId":{"edit":{"label":"cartId","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"cartId","searchable":true,"sortable":true}},"createAt":{"edit":{"label":"createAt","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"createAt","searchable":true,"sortable":true}},"createBy":{"edit":{"label":"createBy","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"createBy","searchable":true,"sortable":true}},"users_permissions_user":{"edit":{"label":"users_permissions_user","description":"","placeholder":"","visible":true,"editable":true,"mainField":"username"},"list":{"label":"users_permissions_user","searchable":true,"sortable":true}},"product":{"edit":{"label":"product","description":"","placeholder":"","visible":true,"editable":true,"mainField":"productName"},"list":{"label":"product","searchable":true,"sortable":true}},"quantity":{"edit":{"label":"quantity","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"quantity","searchable":true,"sortable":true}},"time":{"edit":{"label":"time","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"time","searchable":true,"sortable":true}},"price":{"edit":{"label":"price","description":"","placeholder":"","visible":true,"editable":true},"list":{"label":"price","searchable":true,"sortable":true}},"brand":{"edit":{"label":"brand","description":"","placeholder":"","visible":true,"editable":true,"mainField":"brandName"},"list":{"label":"brand","searchable":true,"sortable":true}},"cart_items":{"edit":{"label":"cart_items","description":"","placeholder":"","visible":true,"editable":true,"mainField":"id"},"list":{"label":"cart_items","searchable":false,"sortable":false}},"createdAt":{"edit":{"label":"createdAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"createdAt","searchable":true,"sortable":true}},"updatedAt":{"edit":{"label":"updatedAt","description":"","placeholder":"","visible":false,"editable":true},"list":{"label":"updatedAt","searchable":true,"sortable":true}},"createdBy":{"edit":{"label":"createdBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"createdBy","searchable":true,"sortable":true}},"updatedBy":{"edit":{"label":"updatedBy","description":"","placeholder":"","visible":false,"editable":true,"mainField":"firstname"},"list":{"label":"updatedBy","searchable":true,"sortable":true}}},"layouts":{"list":["id","cartId","createAt","createBy"],"edit":[[{"name":"cartId","size":6},{"name":"createAt","size":6}],[{"name":"createBy","size":6},{"name":"users_permissions_user","size":6}],[{"name":"product","size":6},{"name":"quantity","size":4}],[{"name":"time","size":6},{"name":"price","size":4}],[{"name":"brand","size":6},{"name":"cart_items","size":6}]]},"uid":"api::cart.cart"}	object	\N	\N
\.
...
79	zaj3hkpyyr6h7h6d3x6dq542	api::cart.cart.find	2025-05-03 21:55:15.603	2025-05-03 21:55:15.603	2025-05-03 21:55:15.604	\N	\N	\N
80	nayi692ezbzq8tfdq7q93w00	api::cart.cart.findOne	2025-05-03 21:55:15.603	2025-05-03 21:55:15.603	2025-05-03 21:55:15.604	\N	\N	\N
81	lbeb3lauyhqzrjrrjv6qg2a0	api::cart.cart.create	2025-05-03 21:55:15.603	2025-05-03 21:55:15.603	2025-05-03 21:55:15.605	\N	\N	\N
82	cmp4lwc3qomhx9ndsxrhw873	api::cart.cart.update	2025-05-03 21:55:15.603	2025-05-03 21:55:15.603	2025-05-03 21:55:15.605	\N	\N	\N
83	jzpuybxiuc26irz3xnbds6qd	api::cart.cart.delete	2025-05-03 21:55:15.603	2025-05-03 21:55:15.603	2025-05-03 21:55:15.605	\N	\N	\N
84	ui61mukddn88hqxre54azrtt	api::cart-item.cart-item.find	2025-05-03 22:00:10.754	2025-05-03 22:00:10.754	2025-05-03 22:00:10.754	\N	\N	\N
85	sk24pwlj2z09czjssqmvp09r	api::cart-item.cart-item.findOne	2025-05-03 22:00:10.754	2025-05-03 22:00:10.754	2025-05-03 22:00:10.755	\N	\N	\N
86	ms60ws0nv6yasnzxxfhq8ts9	api::cart-item.cart-item.create	2025-05-03 22:00:10.754	2025-05-03 22:00:10.754	2025-05-03 22:00:10.755	\N	\N	\N
87	rbsz92kwc4hptnmxwmyejwnw	api::cart-item.cart-item.update	2025-05-03 22:00:10.754	2025-05-03 22:00:10.754	2025-05-03 22:00:10.755	\N	\N	\N
88	j7ldjofycbtfp0151pdojm53	api::cart-item.cart-item.delete	2025-05-03 22:00:10.754	2025-05-03 22:00:10.754	2025-05-03 22:00:10.756	\N	\N	\N
89	xyjfm5zlnepqzihjnr4fl7mc	api::cart.cart.find	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	\N	\N	\N
90	xg4dm8rdif79wbybtq6hkahw	api::cart.cart.create	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.623	\N	\N	\N
91	pwca48ikhaz4cis5af1mirkh	api::cart.cart.findOne	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.622	\N	\N	\N
92	l37caedup07j2c8pwegrqkk7	api::cart.cart.update	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.623	\N	\N	\N
93	ast95y86m1jvhc93b0qzoe4v	api::cart.cart.delete	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.623	\N	\N	\N
94	xi4vh6untm9ucm6ppihexd6p	api::cart-item.cart-item.find	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.624	\N	\N	\N
95	k0iqzba5nzrycymj5wher89a	api::cart-item.cart-item.create	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.624	\N	\N	\N
96	aocaj2dpabc4povzn6ax6sl0	api::cart-item.cart-item.findOne	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.624	\N	\N	\N
97	hig1vpkbqbucau8snfpweotv	api::cart-item.cart-item.update	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.625	\N	\N	\N
98	e1m7wu1i2cg9z3dcl66urry8	api::cart-item.cart-item.delete	2025-05-04 21:43:43.621	2025-05-04 21:43:43.621	2025-05-04 21:43:43.625	\N	\N	\N
99	pg2kbglrek04v2n8mujd7x21	api::reaction.reaction.toggleReaction	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	\N	\N	\N
100	kgr8g6ghp9p4814x3zy4xl9o	api::reaction.reaction.getProductReactionsStats	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	\N	\N	\N
101	wfdejzr55ngmfqays5s74ntt	api::reaction.reaction.update	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	\N	\N	\N
102	bvp8nsip0jkgdv9tjbi06n6x	api::reaction.reaction.create	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	\N	\N	\N
103	dzfkslzptnu9pnkdkhgkadji	api::reaction.reaction.delete	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	2025-05-04 21:43:54.644	\N	\N	\N
\.
...
1	en6dr53lyxsdi8xeoclld0n2	Authenticated	Default role given to authenticated user.	authenticated	2025-04-14 19:18:04.326	2025-05-04 21:01:10.388	2025-04-14 19:18:04.326	\N	\N	\N
2	fiis7geysekpl7vpoqhwuaxn	Public	Default role given to unauthenticated user.	public	2025-04-14 19:18:04.327	2025-05-04 21:43:54.639	2025-04-14 19:18:04.327	\N	\N	\N
\.
...
SELECT pg_catalog.setval('public.admin_permissions_id_seq', 383, true);
...
SELECT pg_catalog.setval('public.admin_permissions_role_lnk_id_seq', 383, true);
...
SELECT pg_catalog.setval('public.brands_products_lnk_id_seq', 442, true);


--
-- Name: cart_items_carts_lnk_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.cart_items_carts_lnk_id_seq', 1, false);
...
--
-- Name: cart_items_products_lnk_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.cart_items_products_lnk_id_seq', 1, false);


--
-- Name: carts_brand_lnk_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.carts_brand_lnk_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.carts_id_seq', 28, true);


--
-- Name: carts_product_lnk_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.carts_product_lnk_id_seq', 1, false);


--
-- Name: carts_users_permissions_user_lnk_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--

SELECT pg_catalog.setval('public.carts_users_permissions_user_lnk_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.favorites_products_lnk_id_seq', 117, true);
...
SELECT pg_catalog.setval('public.files_related_mph_id_seq', 2809, true);
...
SELECT pg_catalog.setval('public.products_categories_lnk_id_seq', 602, true);
...
SELECT pg_catalog.setval('public.products_id_seq', 603, true);
...
SELECT pg_catalog.setval('public.products_product_ratings_lnk_id_seq', 170, true);
...
SELECT pg_catalog.setval('public.products_shipping_types_lnk_id_seq', 609, true);
...
SELECT pg_catalog.setval('public.reactions_product_lnk_id_seq', 158, true);
...
SELECT pg_catalog.setval('public.up_permissions_id_seq', 103, true);
...
SELECT pg_catalog.setval('public.up_permissions_role_lnk_id_seq', 103, true);
...
--
-- Name: cart_items_carts_lnk cart_items_carts_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_carts_lnk
    ADD CONSTRAINT cart_items_carts_lnk_pkey PRIMARY KEY (id);


--
-- Name: cart_items_carts_lnk cart_items_carts_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_carts_lnk
    ADD CONSTRAINT cart_items_carts_lnk_uq UNIQUE (cart_item_id, cart_id);
...
--
-- Name: cart_items_products_lnk cart_items_products_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_products_lnk
    ADD CONSTRAINT cart_items_products_lnk_pkey PRIMARY KEY (id);


--
-- Name: cart_items_products_lnk cart_items_products_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_products_lnk
    ADD CONSTRAINT cart_items_products_lnk_uq UNIQUE (cart_item_id, product_id);


--
-- Name: carts_brand_lnk carts_brand_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_brand_lnk
    ADD CONSTRAINT carts_brand_lnk_pkey PRIMARY KEY (id);


--
-- Name: carts_brand_lnk carts_brand_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_brand_lnk
    ADD CONSTRAINT carts_brand_lnk_uq UNIQUE (cart_id, brand_id);
...
--
-- Name: carts_product_lnk carts_product_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_product_lnk
    ADD CONSTRAINT carts_product_lnk_pkey PRIMARY KEY (id);


--
-- Name: carts_product_lnk carts_product_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_product_lnk
    ADD CONSTRAINT carts_product_lnk_uq UNIQUE (cart_id, product_id);


--
-- Name: carts_users_permissions_user_lnk carts_users_permissions_user_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_users_permissions_user_lnk
    ADD CONSTRAINT carts_users_permissions_user_lnk_pkey PRIMARY KEY (id);


--
-- Name: carts_users_permissions_user_lnk carts_users_permissions_user_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_users_permissions_user_lnk
    ADD CONSTRAINT carts_users_permissions_user_lnk_uq UNIQUE (cart_id, user_id);
...
--
-- Name: cart_items_carts_lnk_fk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX cart_items_carts_lnk_fk ON public.cart_items_carts_lnk USING btree (cart_item_id);


--
-- Name: cart_items_carts_lnk_ifk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX cart_items_carts_lnk_ifk ON public.cart_items_carts_lnk USING btree (cart_id);


--
-- Name: cart_items_carts_lnk_ofk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX cart_items_carts_lnk_ofk ON public.cart_items_carts_lnk USING btree (cart_ord);


--
-- Name: cart_items_carts_lnk_oifk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX cart_items_carts_lnk_oifk ON public.cart_items_carts_lnk USING btree (cart_item_ord);


--
-- Name: cart_items_created_by_id_fk; Type: INDEX; Schema: public; Owner: admin
--
...
--
-- Name: cart_items_documents_idx; Type: INDEX; Schema: public; Owner: admin
--
...
--
-- Name: cart_items_products_lnk_fk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX cart_items_products_lnk_fk ON public.cart_items_products_lnk USING btree (cart_item_id);


--
-- Name: cart_items_products_lnk_ifk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX cart_items_products_lnk_ifk ON public.cart_items_products_lnk USING btree (product_id);


--
-- Name: cart_items_products_lnk_ofk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX cart_items_products_lnk_ofk ON public.cart_items_products_lnk USING btree (product_ord);


--
-- Name: cart_items_products_lnk_oifk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX cart_items_products_lnk_oifk ON public.cart_items_products_lnk USING btree (cart_item_ord);


--
-- Name: cart_items_updated_by_id_fk; Type: INDEX; Schema: public; Owner: admin
--
...
--
-- Name: carts_brand_lnk_fk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_brand_lnk_fk ON public.carts_brand_lnk USING btree (cart_id);


--
-- Name: carts_brand_lnk_ifk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_brand_lnk_ifk ON public.carts_brand_lnk USING btree (brand_id);


--
-- Name: carts_created_by_id_fk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_created_by_id_fk ON public.carts USING btree (created_by_id);


--
-- Name: carts_documents_idx; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_documents_idx ON public.carts USING btree (document_id, locale, published_at);


--
-- Name: carts_product_lnk_fk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_product_lnk_fk ON public.carts_product_lnk USING btree (cart_id);


--
-- Name: carts_product_lnk_ifk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_product_lnk_ifk ON public.carts_product_lnk USING btree (product_id);


--
-- Name: carts_product_lnk_oifk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_product_lnk_oifk ON public.carts_product_lnk USING btree (cart_ord);


--
-- Name: carts_updated_by_id_fk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_updated_by_id_fk ON public.carts USING btree (updated_by_id);


--
-- Name: carts_users_permissions_user_lnk_fk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_users_permissions_user_lnk_fk ON public.carts_users_permissions_user_lnk USING btree (cart_id);


--
-- Name: carts_users_permissions_user_lnk_ifk; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX carts_users_permissions_user_lnk_ifk ON public.carts_users_permissions_user_lnk USING btree (user_id);
...
--
-- Name: cart_items_carts_lnk cart_items_carts_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_carts_lnk
    ADD CONSTRAINT cart_items_carts_lnk_fk FOREIGN KEY (cart_item_id) REFERENCES public.cart_items(id) ON DELETE CASCADE;


--
-- Name: cart_items_carts_lnk cart_items_carts_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_carts_lnk
    ADD CONSTRAINT cart_items_carts_lnk_ifk FOREIGN KEY (cart_id) REFERENCES public.carts(id) ON DELETE CASCADE;


--
-- Name: cart_items cart_items_created_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: cart_items_products_lnk cart_items_products_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_products_lnk
    ADD CONSTRAINT cart_items_products_lnk_fk FOREIGN KEY (cart_item_id) REFERENCES public.cart_items(id) ON DELETE CASCADE;


--
-- Name: cart_items_products_lnk cart_items_products_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.cart_items_products_lnk
    ADD CONSTRAINT cart_items_products_lnk_ifk FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE;


--
-- Name: cart_items cart_items_updated_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: carts_brand_lnk carts_brand_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_brand_lnk
    ADD CONSTRAINT carts_brand_lnk_fk FOREIGN KEY (cart_id) REFERENCES public.carts(id) ON DELETE CASCADE;


--
-- Name: carts_brand_lnk carts_brand_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_brand_lnk
    ADD CONSTRAINT carts_brand_lnk_ifk FOREIGN KEY (brand_id) REFERENCES public.brands(id) ON DELETE CASCADE;


--
-- Name: carts carts_created_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts
    ADD CONSTRAINT carts_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;


--
-- Name: carts_product_lnk carts_product_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_product_lnk
    ADD CONSTRAINT carts_product_lnk_fk FOREIGN KEY (cart_id) REFERENCES public.carts(id) ON DELETE CASCADE;


--
-- Name: carts_product_lnk carts_product_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_product_lnk
    ADD CONSTRAINT carts_product_lnk_ifk FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE CASCADE;


--
-- Name: carts carts_updated_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts
    ADD CONSTRAINT carts_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;


--
-- Name: carts_users_permissions_user_lnk carts_users_permissions_user_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_users_permissions_user_lnk
    ADD CONSTRAINT carts_users_permissions_user_lnk_fk FOREIGN KEY (cart_id) REFERENCES public.carts(id) ON DELETE CASCADE;


--
-- Name: carts_users_permissions_user_lnk carts_users_permissions_user_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.carts_users_permissions_user_lnk
    ADD CONSTRAINT carts_users_permissions_user_lnk_ifk FOREIGN KEY (user_id) REFERENCES public.up_users(id) ON DELETE CASCADE;
