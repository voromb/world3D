...
1929	214	422	api::product.product	images	1
1930	215	422	api::product.product	images	2
1931	216	422	api::product.product	images	3
1932	217	422	api::product.product	images	4
1933	218	422	api::product.product	images	5
...
422	x750yufmey1bekoymdo0dhyx	Kit de reparación para impresoras 3D	kit-de-reparacion-para-impresoras-3-d	Kit de reparación para impresoras 3D	t	29.99	t	2025-04-16 21:57:54.317	2025-05-01 19:23:20.19	2025-05-01 19:23:20.212	1	1	\N	5.50	20x20x5	2025-04-02	24 meses	Nuevo	Toledo	Toledo	España	Calle Real 606	39.862832	-4.027323	\N	\N	16	\N	\N
...
SELECT pg_catalog.setval('public.brands_products_lnk_id_seq', 384, true);
...
SELECT pg_catalog.setval('public.files_related_mph_id_seq', 2453, true);
...
SELECT pg_catalog.setval('public.products_categories_lnk_id_seq', 528, true);
...
SELECT pg_catalog.setval('public.products_id_seq', 503, true);
...
SELECT pg_catalog.setval('public.products_shipping_types_lnk_id_seq', 535, true);
